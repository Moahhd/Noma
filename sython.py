...
sython.start()
c = requests.session()
bot_username = '@Jsjshshsjbot'
bot_usernamee = '@Jsjshshsjbot'
...
async def join_channel():
    try:
        await sython(JoinChannelRequest("@patatavip"))
...
async def _(event):
    ...
    await event.edit(f'''
𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘵𝘩𝘦 𝘩𝘢𝘯𝘯𝘢𝘩 2.0 𝘴𝘰𝘶𝘳𝘤𝘦. 𝘵𝘩𝘦 𝘴𝘰𝘶𝘳𝘤𝘦 𝘸𝘢𝘴 𝘤𝘳𝘦𝘢𝘵𝘦𝘥 𝘵𝘰 𝘤𝘩𝘦𝘤𝘬 𝘶𝘴𝘦𝘳𝘯𝘢𝘮𝘦𝘴 𝘣𝘺 𝘵𝘩𝘦 𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 𝘣𝘢𝘵𝘢𝘵𝘢.
——————————————————
𝘴𝘰𝘶𝘳𝘤𝘦 𝘩𝘢𝘯𝘯𝘢 2.0
𝘱𝘪𝘯𝘨 : {ms}
𝘥𝘢𝘵𝘦 : {m9zpi}
...
async def _(event):
        ...
        await sython.send_message('@Jsjshshsjbot', 'جاري التجميع بواسطة | BATATA')
        channel_entity = await sython.get_entity(bot_username)
        await sython.send_message('@Jsjshshsjbot', '/start')
        await asyncio.sleep(5)
        msg0 = await sython.get_messages('@Jsjshshsjbot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sython.get_messages('@Jsjshshsjbot', limit=1)
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                await sython.send_message(event.chat_id, f"لايوجد قنوات  في البوت ")
                break
            ...
            try:
                ...
                msg2 = await sython.get_messages('@Jsjshshsjbot', limit=1)
...
async def _(event):
        ...
        await sython.send_message('@patatavipbot', 'جاري التجميع بواسطة | SOMY TEAM')
        channel_entity = await sython.get_entity(bot_usernamee)
        await sython.send_message('@patatavipbot', '/start')
        await asyncio.sleep(5)
        msg0 = await sython.get_messages('@patatavipbot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await sython.get_messages('@patatavipbot', limit=1)
        await msg1[0].click(0)
        ...
        for i in range(100):
            ...
            try:
                try:
                    ...
                    bott = url.split('/')[-1]
                    await sython(ImportChatInviteRequest(bott))
                msg2 = await sython.get_messages('@patatavipbot', limit=1)
                await msg2[0].click(text='تحقق')
                chs += 1
...
async def _(event):
      await event.reply("""𝚂𝙾𝙺𝚁𝙲𝙴 𝚆𝙾𝚁𝙺𝚂 𝚆𝙸𝚃𝙷 𝚆𝙸𝙽𝙶 | 𝙿𝙰𝚃𝙰𝚃𝙰 | 
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 • @patatavip
𝚂𝙾𝙺𝚁𝙲𝙴 𝙲𝙷𝙴𝙲𝙺 
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍ """
...
async def _(event):
      await event.reply("""𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 • @PATATAVIP"""
)
