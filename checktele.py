        ...
        for i in range(int(msg[0])):
            ...
            if "Available" in isav:
                ...
                try:
                    ...
                    await event.client.send_file(event.chat_id, "https://t.me/cc_king_the/1382", caption=f'''
⤷ 🥷🏻 ❲ UsEr ❳ ⌯ @{username} 
⤷ 🥷🏻 ❲ clicks ❳ ⌯ {trys}
⤷  ❲ @cc_king_the ❳ ''')
                    await event.client.send_file("@pataavip", "https://t.me/cc_king_the/1382", caption=f'''
⤷ 🥷🏻 ❲ UsEr ❳ ⌯ @{username} 
⤷ 🥷🏻 ❲ clicks ❳ ⌯ {trys}''') 
                    break
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message(event.chat_id, "Selling IDs : @lllllj ")
            ...
            for i in range(int(msg[0])):
                ...
                if "Available" in isav:
                    try:
                        await sython(functions.channels.UpdateUsernameRequest(
                            channel=ch, username=username))
                        await event.client.send_message("@patatavip", f'''
⤷ 🥷🏻 ❲ UsEr ❳ ⌯ @{username} 
⤷ 🥷🏻 ❲ clicks ❳ ⌯ {trys}
⤷  ❲ @cc_king_the ❳    ''')
                        break
                    except telethon.errors.rpcerrorlist.UsernameInvalidError:
                        await event.client.send_message(event.chat_id, f"Bannad usar`{username}`❌")
                        break
                    except Exception as eee:
